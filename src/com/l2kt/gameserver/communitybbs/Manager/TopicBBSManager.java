...
public class TopicBBSManager extends BaseBBSManager
{
	...
	public void parseWrite(String ar1, String ar2, String ar3, String ar4, String ar5, Player player)
	{
		if (ar1.equals("crea"))
		{
			...
			forum.vload();
			final Topic topic = new Topic(Topic.ConstructorType.CREATE, TopicBBSManager.getInstance().getMaxID(forum) + 1, Integer.parseInt(ar2), ar5, Calendar.getInstance().getTimeInMillis(), player.getName(), player.getObjectId(), Topic.MEMO, 0);
