...
public class Npc extends Creature
{
	...
	public static void showQuestWindowGeneral(Player player, Npc npc)
	{
		...
		List<Quest> scripts = npc.getTemplate().getEventQuests(EventType.ON_TALK);
		if (scripts != null)
		{
		...
		scripts = npc.getTemplate().getEventQuests(EventType.QUEST_START);
		if (scripts != null)
		{
			for (Quest quest : scripts)
			{
	...
	public static void showQuestWindowSingle(Player player, Npc npc, Quest quest)
	{
		...
		if (qs == null)
		{
			...
			final List<Quest> scripts = npc.getTemplate().getEventQuests(EventType.QUEST_START);
	...
	public void onSpawn()
	{
		...
		final List<Quest> scripts = getTemplate().getEventQuests(EventType.ON_SPAWN);
		if (scripts != null)
			for (Quest quest : scripts)
	...
	public void onDecay()
	{
		...
		final List<Quest> scripts = getTemplate().getEventQuests(EventType.ON_DECAY);
		if (scripts != null)
			for (Quest quest : scripts)
	...
	{
		final List<Quest> scripts = getTemplate().getEventQuests(EventType.ON_SPELL_FINISHED);
		if (scripts != null)
		{
