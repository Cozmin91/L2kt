...
public class CreatureAI extends AbstractAI
{
	 ...
	 * <li>Stop the actor attack stance.</li>
	...
	protected void onIntentionActive()
	{
		...
		if (_desire.getIntention() != CtrlIntention.ACTIVE)
		{
	 ...
	 * <li>Start the actor attack stance.</li>
	 * <li>Launch the Think Event</li>
	 * </ul>
	 */
	@Override
	...
	{
		if (_desire.getIntention() == CtrlIntention.REST && skill.isMagic())
		{
			clientActionFailed();
	 ...
	 * <li>Move the actor to Location (x,y,z).</li>
	 * </ul>
	 */
	@Override
	 ...
	 * <li>Launch a task executed every 1s to calculate the movement on the fly.</li>
	 * </ul>
	 */
	@Override
	...
	protected void onIntentionPickUp(WorldObject object)
	{
		...
		if (object instanceof ItemInstance && ((ItemInstance) object).getLocation() != ItemInstance.ItemLocation.VOID)
			return;
	...
	{
		// If the Intention was MOVE_TO, set the Intention to ACTIVE
		if (_desire.getIntention() == CtrlIntention.MOVE_TO || _desire.getIntention() == CtrlIntention.CAST)
			setIntention(CtrlIntention.ACTIVE);
