...
class VillageMasterFighter(objectId: Int, template: NpcTemplate) : VillageMaster(objectId, template) {
    ...
    override fun checkVillageMasterTeachType(pclass: ClassId?): Boolean {
        return if (pclass == null) false else pclass.type === ClassType.FIGHTER
    }
}