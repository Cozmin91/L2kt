...
public final class Player extends Playable
{
	...
	public Forum getMemo()
	{
		if (_forumMemo == null)
		{
			final Forum forum = ForumsBBSManager.INSTANCE.getForumByName("MemoRoot");
			if (forum != null)
			{
				_forumMemo = forum.getChildByName(_accountName);
				if (_forumMemo == null)
					_forumMemo = ForumsBBSManager.INSTANCE.createNewForum(_accountName, forum, Forum.MEMO, Forum.OWNERONLY, getObjectId());
			}
		}
		return _forumMemo;
	}
