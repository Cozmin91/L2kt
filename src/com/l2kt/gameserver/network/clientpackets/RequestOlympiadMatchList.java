...
public final class RequestOlympiadMatchList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			StringUtil.INSTANCE.append(sb, "<tr><td fixwidth=10><a action=\"bypass arenachange ", i, "\">", ++i, "</a></td><td fixwidth=80>");
			...
			if (task.isGameStarted())
			{
				...
				StringUtil.INSTANCE.append(sb, "</td><td>", task.getGame().getPlayerNames()[0], "&nbsp; / &nbsp;", task.getGame().getPlayerNames()[1]);
			}
			else
				StringUtil.INSTANCE.append(sb, "&$906;", "</td><td>&nbsp;"); // Initial State
				
			StringUtil.INSTANCE.append(sb, "</td><td><font color=\"aaccff\"></font></td></tr>");
		}
