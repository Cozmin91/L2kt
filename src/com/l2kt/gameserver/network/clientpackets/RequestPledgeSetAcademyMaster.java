...
public final class RequestPledgeSetAcademyMaster extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (_set == 0)
		{
			...
			sm = SystemMessage.Companion.getSystemMessage(SystemMessageId.S2_CLAN_MEMBER_S1_APPRENTICE_HAS_BEEN_REMOVED);
		}
		else
		{
			...
			sm = SystemMessage.Companion.getSystemMessage(SystemMessageId.S2_HAS_BEEN_DESIGNATED_AS_APPRENTICE_OF_CLAN_MEMBER_S1);
		}
