 ...
 */
    (attacker: Creature, val soulshot: Boolean, val _ssGrade: Int) : L2GameServerPacket() {
    ...
    private var _hits: MutableList<Hit> = mutableListOf()
    ...
    fun hit(vararg hits: Hit) {
        ...
        _hits = tmp.filterNotNull().toMutableList()
    }
