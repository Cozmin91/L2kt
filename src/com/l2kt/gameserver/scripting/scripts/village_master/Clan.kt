...
class Clan : Quest(-1, "village_master") {
    init {
    ...
    override fun onAdvEvent(event: String, npc: Npc?, player: Player?): String? {
        when (event) {
            ...
            "9000-07.htm", "9000-08.htm", "9000-12a.htm", "9000-13a.htm", "9000-13b.htm", "9000-14a.htm", "9000-15.htm" -> if (player?.isClanLeader == false)
