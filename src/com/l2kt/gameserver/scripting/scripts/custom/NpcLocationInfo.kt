 ...
 */
class NpcLocationInfo : Quest(-1, "custom") {
    init {
    ...
    companion object {
        private const val qn = "NpcLocationInfo"

        private val RADARS = intArrayOf(
            // Talking Island
