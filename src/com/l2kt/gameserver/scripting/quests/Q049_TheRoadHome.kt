...
class Q049_TheRoadHome : Quest(49, "The Road Home") {
    init {
    ...
    override fun onTalk(npc: Npc, player: Player): String? {
        ...
        when (st.state) {
            Quest.STATE_CREATED -> if (player.race == ClassRace.DWARF && player.level >= 3) {
    ...
    companion object {
        private const val qn = "Q049_TheRoadHome"
        ...
        private const val SCROLL_OF_ESCAPE_SPECIAL = 7558
    }
}