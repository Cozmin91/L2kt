...
class Q046_OnceMoreInTheArmsOfTheMotherTree : Quest(46, "Once More In the Arms of the Mother Tree") {
    init {
    ...
    override fun onTalk(npc: Npc, player: Player): String? {
        ...
        when (st.state) {
            Quest.STATE_CREATED -> if (player.race == ClassRace.ELF && player.level >= 3) {
    ...
    companion object {
        private const val qn = "Q046_OnceMoreInTheArmsOfTheMotherTree"
        ...
        private const val SCROLL_OF_ESCAPE_SPECIAL = 7555
    }
}