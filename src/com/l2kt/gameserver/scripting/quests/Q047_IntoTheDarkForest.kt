...
class Q047_IntoTheDarkForest : Quest(47, "Into the Dark Forest") {
    init {
    ...
    override fun onTalk(npc: Npc, player: Player): String? {
        ...
        when (st.state) {
            Quest.STATE_CREATED -> if (player.race == ClassRace.DARK_ELF && player.level >= 3) {
    ...
    companion object {
        private const val qn = "Q047_IntoTheDarkForest"
        ...
        private const val SCROLL_OF_ESCAPE_SPECIAL = 7556
    }
}