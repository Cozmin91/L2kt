...
object BoatManager {
    ...
    fun getNewBoat(boatId: Int, x: Int, y: Int, z: Int, heading: Int): Boat {
        ...
        set.set("hp", 50000.toInt())
        set.set("mp", 0.toInt())

        set.set("hpRegen", 3e-3)
        set.set("mpRegen", 3e-3)

        set.set("radius", 0.toInt())
        set.set("height", 0.toInt())
        set.set("type", "")

        set.set("exp", 0.toInt())
        set.set("sp", 0.toInt())

        set.set("pAtk", 0.toInt())
        set.set("mAtk", 0.toInt())
        set.set("pDef", 100.toInt())
        set.set("mDef", 100.toInt())

        set.set("rHand", 0.toInt())
        set.set("lHand", 0.toInt())

        set.set("walkSpd", 0.toInt())
        set.set("runSpd", 0.toInt())
